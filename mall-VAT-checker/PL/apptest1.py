...
class NIPKombajn(ctk.CTk):
    def __init__(self):
        ...
        # Novej luxusní progress bar
        self.progress_bar = ctk.CTkProgressBar(self, width=300)
        self.progress_bar.pack(pady=(0, 10))
        self.progress_bar.set(0) # Vyresetováno na startu
    ...
    def makej(self):
        ...
        try:
            ...
            if sid_element is None or not sid_element.text:
                self.status_label.configure(text="Zamítnuto produkcí! GUS tenhle klíč prostě nezná.", text_color="red")
                return
            ...
            self.status_label.configure(text=f"Hotovo bejku! Zmáklo to {celkem} NIPů. Excel je uloženej.", text_color="green")
